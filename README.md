...
**후속 Phase:** R10-S4 ASOS/Calendar 적재 · R10-S5 Forecast On-demand Input Provider · R10-S6 데이터 적재 스케줄러

**이번 Phase 범위 외 (후속):** ASOS/Calendar(R10-S4), Forecast on-demand(R10-S5), 스케줄러(R10-S6)
