...
- **과거 vs 미래 기상:** ASOS 관측값은 학습용 과거 데이터. 미래 예측 시점 기상은 **R10-S5 Forecast on-demand**에서 처리 (이번 Phase 미구현)
...
**후속 Phase:** R10-S5 Forecast On-demand Input Provider · R10-S6 데이터 적재 스케줄러 · upsert/중복 제거 고도화

**이번 Phase 범위 외 (후속):** 단기예보 on-demand(R10-S5), 스케줄러(R10-S6), upsert 고도화
