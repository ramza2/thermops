...
class PipelineDefinition(Base):
    ...
    description: Mapped[str | None] = mapped_column(Text)
    pipeline_type: Mapped[str] = mapped_column(String(80))
    pipeline_kind: Mapped[str] = mapped_column(String(50), default="MLOPS_FLOW")
    airflow_dag_id: Mapped[str | None] = mapped_column(String(200))
    ...
    current_graph_json: Mapped[dict | None] = mapped_column(JSONB)
    current_sync_status: Mapped[str] = mapped_column(String(30), default="NOT_COMPILED")
    status: Mapped[str] = mapped_column(String(30), default="DRAFT")
...
class VisualPipelineRun(Base):
    ...
    retry_of_run_id: Mapped[str | None] = mapped_column(String(40))
    retry_attempt: Mapped[int] = mapped_column(Integer, default=0)
    retry_reason: Mapped[str | None] = mapped_column(String(300))
    retry_mode: Mapped[str | None] = mapped_column(String(40))
    ...
    cancel_acknowledged_at: Mapped[datetime | None] = mapped_column(DateTime)
    catchup_of_activation_id: Mapped[str | None] = mapped_column(String(40))
    catchup_for_scheduled_at: Mapped[datetime | None] = mapped_column(DateTime)
    catchup_reason: Mapped[str | None] = mapped_column(String(300))
    catchup_requested_by: Mapped[str | None] = mapped_column(String(120))
    catchup_requested_at: Mapped[datetime | None] = mapped_column(DateTime)
    started_at: Mapped[datetime | None] = mapped_column(DateTime)
    finished_at: Mapped[datetime | None] = mapped_column(DateTime)
    created_at: Mapped[datetime] = mapped_column(DateTime)
...
class VisualPipelineScheduleActivation(Base):
    ...
    last_due_at: Mapped[datetime | None] = mapped_column(DateTime)
    last_skip_at: Mapped[datetime | None] = mapped_column(DateTime)
    last_skip_reason: Mapped[str | None] = mapped_column(String(80))
