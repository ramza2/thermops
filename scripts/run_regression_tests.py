...
def _build_registry() -> list[TestCase]:
    return [
        ...
        _python_test(
            "test_feature_recipe_build_diagnostics.py",
            groups=["model", "full"],
            description="Recipe Engine Build diagnostics (R6-S1)",
            timeout_seconds=300,
        ),
        _python_test(
        ...
        _python_test(
            ...
            groups=["model", "full"],
            description="Feature Registry·Lineage",
            timeout_seconds=180,
        ),
        _python_test(
            "test_feature_build_jobs.py",
            groups=["model", "full"],
            description="Feature Build Job 이력 API",
            timeout_seconds=180,
        ),
        _python_test(
        ...
        _python_test(
            "test_feature_registration_validation.py",
            groups=["model", "full"],
            description="Feature 등록·Registry 검증",
            timeout_seconds=240,
        ),
        _python_test(
        ...
        _python_test(
            "test_feature_recipe_templates.py",
            groups=["model", "full"],
            description="Feature Recipe Template Catalog (R2)",
            timeout_seconds=120,
        ),
        _python_test(
        ...
        _python_test(
            "test_feature_recipes.py",
            groups=["model", "full"],
            description="Feature Recipe 저장·발행 (R5)",
            timeout_seconds=180,
        ),
        _python_test(
        ...
        _python_test(
            "test_visual_pipeline_graph_storage.py",
            groups=["model", "full"],
            description="Visual Pipeline graph storage / CRUD (R11-S2)",
            timeout_seconds=180,
        ),
        _python_test(
            "test_visual_pipeline_graph_validation.py",
            groups=["model", "full", "quick"],
            description="Visual Pipeline graph validation (R11-S4-1)",
            timeout_seconds=120,
        ),
        _python_test(
