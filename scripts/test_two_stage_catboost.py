...
TRAINING_CONFIG_ID = os.environ.get("THERMOOPS_TRAINING_CONFIG_ID", "TRC-TPL-TWO-STAGE-CATBOOST")
...
def ensure_training_configs_seed() -> None:
    ...
    ('TRC-TPL-TWO-STAGE-CATBOOST', '2-Stage CatBoost 학습', 'FS-TPL-TWO-STAGE', 'two_stage_catboost', 1, 1, '{"validation_ratio":0.2,"iterations":50,"learning_rate":0.05,"depth":6}')
